...
Builder builder(BuilderOptions _) => LibraryBuilder(ToStringGenerator(),
    formatOutput: (code) => code, generatedExtension: '.to_string.dart');
...
class ToStringGenerator extends GeneratorForAnnotation {
  ...
  @override
  TypeChecker get typeChecker => TypeChecker.fromRuntime(ToString);
}
