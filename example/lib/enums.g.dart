...
const TestEnum _$yes = TestEnum._('yes');
const TestEnum _$no = TestEnum._('no');
const TestEnum _$maybe = TestEnum._('maybe');
...
const SecondTestEnum _$ys = SecondTestEnum._('yes');
const SecondTestEnum _$n = SecondTestEnum._('no');
const SecondTestEnum _$definitely = SecondTestEnum._('definitely');
...
const WireNameEnum _$wireYes = WireNameEnum._('yes');
const WireNameEnum _$wireNo = WireNameEnum._('no');
const WireNameEnum _$wireDefinitely = WireNameEnum._('definitely');
