...
Serializer<GenericValue> _$genericValueSerializer = _$GenericValueSerializer();
      ...
      switch (key) {
        case 'values':
          result.values.replace(serializers.deserialize(value,
              specifiedType: FullType(BuiltList, [parameterT])) as BuiltList);
          break;
      }
    }
  ...
  Iterable serialize(Serializers serializers, GenericContainer object,
    ...
    final result = <Object>[
      ...
      serializers.serialize(object.genericValue,
          specifiedType: const FullType(GenericValue, [FullType(String)])),
      'boundGenericValue',
      serializers.serialize(object.boundGenericValue,
          specifiedType: const FullType(BoundGenericValue, [FullType(double)])),
      'collectionGenericValue',
      serializers.serialize(object.collectionGenericValue,
          specifiedType:
              const FullType(CollectionGenericValue, [FullType(String)])),
    ];
        ...
        case 'collectionGenericValue':
          result.collectionGenericValue.replace(serializers.deserialize(value,
                  specifiedType: const FullType(
                      CollectionGenericValue, [FullType(String)]))
...
class _$GenericValue<T> extends GenericValue<T> {
  ...
  factory _$GenericValue([void updates(GenericValueBuilder<T> b)]) =>
      (GenericValueBuilder<T>()..update(updates)).build();

  _$GenericValue._({this.value}) : super._() {
    if (value == null) throw BuiltValueNullFieldError('GenericValue', 'value');
    if (T == dynamic) throw BuiltValueMissingGenericsError('GenericValue', 'T');
  }
...
class GenericValueBuilder<T>
  ...
  _$GenericValue<T> build() {
    final _$result = _$v ?? _$GenericValue<T>._(value: value);
    replace(_$result);
    return _$result;
  }
}
...
class _$BoundGenericValue<T extends num> extends BoundGenericValue<T> {
  ...
  factory _$BoundGenericValue([void updates(BoundGenericValueBuilder<T> b)]) =>
      (BoundGenericValueBuilder<T>()..update(updates)).build();

  _$BoundGenericValue._({this.value}) : super._() {
    if (value == null)
      throw BuiltValueNullFieldError('BoundGenericValue', 'value');
    if (T == dynamic)
      throw BuiltValueMissingGenericsError('BoundGenericValue', 'T');
  }
...
class BoundGenericValueBuilder<T extends num>
  ...
  _$BoundGenericValue<T> build() {
    final _$result = _$v ?? _$BoundGenericValue<T>._(value: value);
    replace(_$result);
    return _$result;
  }
}
...
class _$CollectionGenericValue<T> extends CollectionGenericValue<T> {
  ...
  factory _$CollectionGenericValue(
      ...
      (CollectionGenericValueBuilder<T>()..update(updates)).build();

  _$CollectionGenericValue._({this.values}) : super._() {
    if (values == null)
      throw BuiltValueNullFieldError('CollectionGenericValue', 'values');
    if (T == dynamic)
      throw BuiltValueMissingGenericsError('CollectionGenericValue', 'T');
  }
...
class _$GenericContainer extends GenericContainer {
  ...
  factory _$GenericContainer([void updates(GenericContainerBuilder b)]) =>
      (GenericContainerBuilder()..update(updates)).build();

  _$GenericContainer._(
      {this.genericValue, this.boundGenericValue, this.collectionGenericValue})
      : super._() {
    if (genericValue == null)
      throw BuiltValueNullFieldError('GenericContainer', 'genericValue');
    if (boundGenericValue == null)
      throw BuiltValueNullFieldError('GenericContainer', 'boundGenericValue');
