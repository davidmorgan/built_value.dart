...
macro class Value implements ClassDeclarationsMacro, ClassTypesMacro {
  ...
  Future<void> buildDeclarationsForClass(IntrospectableClassDeclaration clazz,
    ...
    for (final field in await builder.fieldsOf(clazz)) {
      fields[clazz.identifier.name]!.add(((field.type as NamedTypeAnnotation).identifier.name, field.type.isNullable, field.identifier.name));
    }
  ...
  FutureOr<void> buildTypesForClass(
    ...
    builder.declareType('ValueNullFieldError',
